"""
MeshSegNet — 官方实现（原样保留，来自 https://github.com/Tai-Hsien/MeshSegNet）

输入格式：
  x:   [B, 15, N]  — 面特征（Conv1d 格式，通道在前）
  a_s: [B, N, N]   — 小尺度归一化邻接矩阵
  a_l: [B, N, N]   — 大尺度归一化邻接矩阵

输出：
  [B, N, num_classes]  — 每面的 Softmax 概率
"""

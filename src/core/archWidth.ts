...
export default class ArchWidth {
    ...
    #init(): void {
        ...
        this.#archBox!.addEventListener("click", (e: MouseEvent) => {
            const type = _T.#type,
                pos = _T.#pos,
                name = _T.#name!
        ...
        this.#archBox!.addEventListener("mouseenter", (e: MouseEvent) => {
            const { x, y } = getMousePosition(e)
        ...
        this.#archBox!.addEventListener("mousemove", (e: MouseEvent) => {
            const { x, y } = getMousePosition(e)
            this.#tag!.style.top = y + 15 + "px"
            this.#tag!.style.left = x + 15 + "px"
        })

        this.#archBox!.addEventListener("mouseleave", () => {
